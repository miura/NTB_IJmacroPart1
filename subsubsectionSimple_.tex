...
If you are using native ImageJ downloaded from NIH site, the the macro editor launches by selecting \ijmenu{[PlugIns -> New -> Macro]} from the menu (\ref{fig_MacroEditor}). Please then write:

\verbprint("Hello World!");}.
