...
If you are using native ImageJ downloaded from NIH site, the the macro editor (Fig.~\ref{fig_MacroEditor}) launches by selecting \ijmenu{[PlugIns -> New -> Macro]} from the menu. Please then write:
